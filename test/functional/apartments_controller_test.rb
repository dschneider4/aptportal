...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { area: @apartment.area, lease: @apartment.lease, lease_expire_date: @apartment.lease_expire_date, name: @apartment.name, photo: @apartment.photo, rent: @apartment.rent, rooms: @apartment.rooms }
    end
  ...
  test "should update apartment" do
    put :update, id: @apartment, apartment: { area: @apartment.area, lease: @apartment.lease, lease_expire_date: @apartment.lease_expire_date, name: @apartment.name, photo: @apartment.photo, rent: @apartment.rent, rooms: @apartment.rooms }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
